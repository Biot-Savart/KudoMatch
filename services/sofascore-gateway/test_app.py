...
class GatewayContractTests(unittest.TestCase):
    ...
    def test_empty_event_pages_treat_upstream_404_as_empty(self) -> None:
        self.assertTrue(is_empty_event_history_path("/unique-tournament/419/season/98406/events/last/0"))
        self.assertTrue(is_empty_event_history_path("/unique-tournament/419/season/98406/events/next/0"))
        self.assertFalse(is_empty_event_history_path("/unique-tournament/419/season/98406/teams"))
