	...
	},
	{
		...
		teams: [
			...
			},
			{
				...
				shortName: 'SHA',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/27.png',
			},
			{
				name: 'Fidelity ADT Lions',
				shortName: 'LIO',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/28.png',
			},
			{
				name: 'Toyota Cheetahs',
				shortName: 'CHE',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/29.png',
			},
			{
				name: 'Suzuki Griquas',
				shortName: 'GRI',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/30.png',
			},
			{
				name: 'Airlink Pumas',
				shortName: 'PUM',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/31.png',
			},
			{
				name: 'Novavit Griffons',
				shortName: 'GRIF',
				countryCode: 'ZA',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/32.png',
			},
		],
	},
	{
		...
		teams: [
			{
				...
				shortName: 'CRU',
				countryCode: 'NZ',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/1.png',
			},
			{
				name: 'Blues',
				shortName: 'BLU',
			...
			},
			{
				...
				shortName: 'HUR',
				countryCode: 'NZ',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/4.png',
			},
			{
				name: 'Highlanders',
				shortName: 'HIG',
				countryCode: 'NZ',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/5.png',
			},
			{
				name: 'ACT Brumbies',
				shortName: 'BRU',
				countryCode: 'AU',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/6.png',
			},
			{
				name: 'Queensland Reds',
				shortName: 'RED',
				countryCode: 'AU',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/7.png',
			},
			{
				name: 'NSW Waratahs',
				shortName: 'WAR',
				countryCode: 'AU',
				mediaUrl: 'https://media.api-sports.io/rugby/teams/8.png',
			},
			{
				name: 'Western Force',
				shortName: 'FOR',
