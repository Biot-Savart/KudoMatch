...
- Status: Phase 1 documentation complete; Phase 2 approved by user; Phase 3 complete; Phase 4 implementation in progress; Phases 5–8 not started.
...
| 4 | In progress | Deliver the approved current provider, including the SofaScore gateway when selected, and pilot Currie Cup and URC | [Primary Current-Provider Pilot](04_primary_current_provider_pilot.md) |
